...
1. exploit the SQL Server links to access other linked SQL Servers.

2. execute `xp_cmdshell`, which will allow me to execute OS commands.

3. download + execute a reverse shell script that will give me a reverse shell on `DEVSRV` as the `DEVSQLADMIN` user. 
